...
CRAWL_CONFIGS = [
    ...
    # -------------------------
    {
        "category_name": "보건/건강",
        "base_url": (
            "https://www.seosan.go.kr/www/selectBbsNttList.do?"
            "key=1379&bbsNo=45&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex="
        ),
    },
    {
        "category_name": "공지사항",
        "base_url": (
            "https://www.seosan.go.kr/www/selectBbsNttList.do?"
            "bbsNo=97&key=1256&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex="
        ),
    },
    {
        "category_name": "보도자료",
        "base_url": (
            "https://www.seosan.go.kr/www/selectBbsNttList.do?"
            "bbsNo=101&key=1260&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex="
        ),
    },
    ...
    # -------------------------
    {
        ...
        "base_url": (
            "https://www.seosan.go.kr/welfare/selectBbsNttList.do?"
            "key=2377&bbsNo=167&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex="
        ),
    },
    {
        ...
        "base_url": (
            "https://www.seosan.go.kr/welfare/selectBbsNttList.do?"
            "bbsNo=166&key=2378&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex="
        ),
    },
    {
        ...
        "base_url": (
            "https://www.seosan.go.kr/welfare/selectBbsNttList.do?"
            "bbsNo=168&key=2379&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex="
        ),
    },
    {
        ...
        "base_url": (
            "https://www.seosan.go.kr/welfare/selectBbsNttList.do?"
            "bbsNo=51&key=2427&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex="
        ),
    },
    {
        ...
        "base_url": (
            "https://www.seosan.go.kr/welfare/selectBbsNttList.do?"
            "bbsNo=2284&key=7634&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex="
        ),
    },
    ...
    # -------------------------
    {
        "category_name": "문화소식",
        "base_url": (
            "https://www.seosan.go.kr/culture/selectBbsNttList.do?"
            "key=818&bbsNo=36&searchCtgry=&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex="
        ),
    },
    {
        "category_name": "시티투어",
        "base_url": (
            "https://www.seosan.go.kr/tour/selectBbsNttList.do?"
            "bbsNo=23&key=971&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex="
        ),
    },
    {
        "category_name": "관광-안내",
        "base_url": (
            "https://www.seosan.go.kr/tour/selectBbsNttList.do?"
            "bbsNo=24&key=976&pageUnit=10&searchCnd=all&searchKrwd=&integrDeptCode=&pageIndex="
        ),
    },

    # -------------------------
    # 읍·면·동 공지사항 (pages_to_crawl = 5)
    # -------------------------
    {
    ...
    },
    {
        ...
        "base_url": "https://www.seosan.go.kr/emd/selectBbsNttList.do?bbsNo=273&key=2020&pageIndex=",
        "pages_to_crawl": 5,
    },
    {
